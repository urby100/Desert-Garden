...
<br>
The rookie pilot stops the plane midflight by mistake... Main character jumps out midflight for some reason.
<br>
<img src="readmesrc/intro2.gif" width=500px></img>
<br>
The main character finds the rookie alive and well sitting inside of the crashed plane. The rookie waves at the protagonist while holding a screwdriver in his hand, the screwdriver slips from his hand onto the bomb below the plane, triggering it and sending the whole plane into the unknown sky :o
<br>
<img src="readmesrc/intro3.gif" width=500px></img>
<br>
The bomb containes chemicals that turn any living thing into something you don't wanna mess with :O(oh, snap)
<br>
...gameplay commences. I didn't have the energy to add a tutorial :D 
<br>
anyway...The cacti can't hurt you, they only disrupt your movement. Only the monsters can kill you.
...
...back to the story
<br>
Protagonist finds the rookie and they head back to HQ.
...
(forgot to add prompt or something that you're all out of water, so you can't use any abilities...)
<br>
### Floor 1
...
<br>
At the end of the story the two chat and see a bigger scarier powerful (cue Oppenheimer "destroyer of worlds") big bomb shot out of HQ. The scientis while under the influence of crazy toxic fumes apparently created it and set a timer to do the thing that it did. Someone's gonna have to clean that up...
<br>
...
### Here is a couple of still frames from 2 characters, and all the plants and "monsters" 😊.
<br>
